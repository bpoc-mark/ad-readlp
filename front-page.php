            ...
            <div class="blob-2 blob">
                <svg viewBox="0 0 800 500" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="100%" id="blobSvg">
                    <g transform="translate(135.713134765625, -9.360885620117188)">
                        <path fill="#fff">
                            <animate attributeName="d" dur="4000ms" repeatCount="indefinite" values="M450,300.5Q407,351,370.5,392.5Q334,434,275.5,457Q217,480,175.5,432Q134,384,94.5,345.5Q55,307,63,252Q71,197,81,131.5Q91,66,157,63Q223,60,279.5,61Q336,62,367,108.5Q398,155,445.5,202.5Q493,250,450,300.5Z;
