        ...
        <div class="l-wrap">
            <div class="c-card01">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <h3 class="col--ttl">
                            効果のある広告で弊社に<br class="u-d-n-sp">
                            関わる全ての人々の、<br class="u-d-n-sp">
                            利益と幸せに貢献する。
                        </h3>
                        <p class="col--desc">
                            弊社は、お客様・媒体社様・社員の方々に支えられ存在しています。<br>
                            どんな時も感謝の気持ちで、全身全霊を尽くし、皆さまの利益・幸せに貢献する事が弊社の存在理由であると考えております。<br>
                            その幸せの輪を高く・社会に広めてゆくために1日1日純粋にたゆまぬ努力を致します。
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="l-wrap">
            <div class="c-card01">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <p class="col--desc">
                            リード、それは集客に困っている人を助ける『レスポンスヒーロー』。<br>
                            私たちが目指すのは、どんな業種、どんな媒体にも関わらず、お客様の期待値を超える結果を出し続ける日本一の集客会社。<br>
                            人を見つめ、世の中を見つめ、時代を見つめることで磨き抜かれる独自の集客論で、日本のレスポンス広告の地位を引き上げ、集客会社というジャンルを世の中に確立する。<br>
                            それこそが、リードにしかできない大きな使命。<br>
                            未だない道を切り拓き、歴史に名を残す集客会社になろう。
                        </p>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col">
                        <p class="col--desc">
                            ...
                            世の中から本当に必要とされなければ、何十年、何百年続く会社になることなんかできない。<br>
                            私たちは、従来の会社の枠組みや固定概念を捨て去り、仕事や遊びも同じように楽しめる環境づくりに全力を尽くす。<br>
